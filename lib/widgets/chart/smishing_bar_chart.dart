...
//     final sortedSmishingKeys = smishingCountPerMonth.keys.toList()
//       ..sort((a, b) {
...
//       });
//     final sortedDoubtKeys = doubtCountPerMonth.keys.toList()
//       ..sort((a, b) {
//         final aParts = a.split('-');
//         final bParts = b.split('-');
//         final aDate = DateTime(int.parse(aParts[0]), int.parse(aParts[1]));
...
//         return aDate.compareTo(bDate);
//       });
//     final smishingY = smishingCountPerMonth.values.reduce((a, b) => a > b ? a : b);
//     final doubtY = doubtCountPerMonth.values.reduce((a, b) => a > b ? a : b);
//     final maxY = ((smishingY + doubtY) * 1.5).ceilToDouble();
//
//     List<BarChartGroupData> barGroups = sortedSmishingKeys
//         .map(
//           (key) => BarChartGroupData(
//         x: sortedSmishingKeys.indexOf(key),
//         barRods: [
//           BarChartRodData(
//             fromY: 0,
//             toY: doubtCountPerMonth[key]!.toDouble(),
//             color: Colors.orange,
...
//           ),
//           BarChartRodData(
//             fromY: doubtCountPerMonth[key]!.toDouble(),
//             toY: smishingCountPerMonth[key]!+doubtCountPerMonth[key]!.toDouble(),
//             color: Colors.red,
//             borderRadius: BorderRadius.zero,
//             width: 20,
//             backDrawRodData: BackgroundBarChartRodData(
...
//                   if (index < 0 || index >= sortedSmishingKeys.length) {
//                     return Text('');
//                   }
//                   final monthYear = sortedSmishingKeys[index];
...
//                 if (index < 0 || index >= sortedSmishingKeys.length + sortedDoubtKeys.length) {
//                   return null;
//                 }
//                 final monthYear = sortedSmishingKeys[index];
//                 final month = monthYear.split('-')[1];
...
class _SmishingBarChartState extends State<SmishingBarChart> {
  ...
  Widget build(BuildContext context) {
    ...
    // final maxY = (smishingCountPerMonth.values.reduce((a, b) => max(a, b)) +
    //     doubtCountPerMonth.values.reduce((a, b) => max(a, b)) * 1.5 + 2).toInt();
